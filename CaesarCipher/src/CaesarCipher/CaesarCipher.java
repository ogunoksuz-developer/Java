...
public class CaesarCipher extends JFrame implements ActionListener
{
    ...
    private static  JLabel        msgLabel        = new JLabel("Mesaj: ");
    private static JLabel        keyLabel        = new JLabel("Key: ");
    private static JLabel        actionLabel     = new JLabel("Seçenek: ");
    private static JLabel        resultLabel     = new JLabel("Sonuç: ");
    private static JTextField    msgTextField    = new JTextField(50);
    private static JTextField    resultTextField = new JTextField(50);
